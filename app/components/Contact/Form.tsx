  ...
  return (
    <section className="min-h-screen">
      <div className="container-sm mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center shadow-[0px_4px_16px_1px_#00000014] -mt-52 mb-[96px] lg:mb-[160px]">
          {/* Contact Information Section */}
          <div className="w-full min-h-[400px] lg:min-h-full order-2 md:order-2 lg:order-1 p-[41px] lg:p-[80px_50px_214px] bg-[#F8E8E8] rounded-[5px]">
            <div>
              ...
              <div className="mt-[40px]">
                ...
                <Link href="/" className="flex items-center gap-2 mb-[48px]">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-[#727272]">
                      07062470966
                    </p>
                  </div>
                </Link>
          ...
          {/* Form Section */}
          <div className="min-w-full min-h-full bg-white order-1 md:order-1 lg:order-2 rounded-[5px]">
            <div className="py-[40px] px-[25px] lg:py-[53px] lg:px-[52px]">
              ...
              <form>
                ...
                <div className="mb-[32px]">
                  ...
                  <textarea 
                    className="w-full h-[144px] lg:h-[152px] bg-[#EFEFEF] rounded-[5px] resize-none p-4 focus:border-[#E72418] focus:outline-none"
                  ></textarea>
                </div>
