...
export default function ShowcaseBanner() {
  return (
    <section className="pt-[60px] lg:pt-[80px] pb-[40px] lg:pb-[100px] relative">
          <Icon
      ...
      <div className="container-sm mx-auto">
        <div className="lg:bg-[#B81A14] rounded-[10px] lg:h-[184px] flex items-center justify-center">
          <div className="lg:py-[37px] lg:px-[126px]">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-[16px] gap-y-[16px] lg:gap-x-[153px]">
              {BannerContents.map((p, i) => (
                <div
                  key={i}
                  className="w-[171px] h-[144px] mx-auto rounded-[10px] lg:min-w-full lg:min-h-full bg-[#B81A14]"
                >
                  <div className="py-[29px] px-[28px] w-full h-full text-center flex items-center justify-center flex-col">
                    <div className="w-[32px] h-[32px] flex items-center justify-center text-white text-2xl mb-[8px] lg:mb-[12px]">
                      {p.icon()} {/* Ensure the function is called */}
                    </div>
