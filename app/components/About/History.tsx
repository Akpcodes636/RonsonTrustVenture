    ...
    <section className="relative">
      ...
      <div className="container-sm mx-auto pt-[40px] lg:pt-[60px] pb-[96px] lg:pb-[160px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-[30px] gap-y-[24px]">
          ...
          <div className="w-full h-full">
            <div className="w-full h-full lg:py-[18.5px] mx-auto lg:px-3">
              ...
              <p className="text-[#000000] text-[18px] leading-[150%] font-normal mb-[24px]">
                ...
                parts for various industries, ensuring seamless operations for
                our clients worldwide.
              </p>

              <p className="text-[#000000] text-[18px] leading-[150%] font-normal mb-[24px]">
                Established in 1990, Ronson Trust Ventures began with a vision
                to bridge the gap in the spare parts industry. Over the years,
                we have built strong partnerships with leading manufacturers and
...
// <div className="relative mx-auto rounded-[5px] overflow-hidden w-[358px] h-[160px] lg:w-[499px] lg:h-[304px] ">
// <Image
