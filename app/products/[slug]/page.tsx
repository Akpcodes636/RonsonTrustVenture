          ...
          <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
            ...
            <div className="mb-8 lg:mb-[56px]">
              ...
              <p className="font-normal text-base md:text-[18px] leading-[150%] mb-4 md:mb-[24px]">
                The Manitowoc 4100W Series 2 crawler crane typically features a
                Cummins NTA-855-C360 diesel engine.
              </p>
              <p className="mb-6 md:mb-[40px] font-normal text-base md:text-[18px] leading-[150%]">
                It is a heavy-duty crawler crane built for high-capacity lifting
                and durability on demanding job sites. Known for its reliability
                and performance, it's a trusted choice for large-scale
